(function($) {
    ...
    function sidebarLogin() {
        var searchTrigger = $('a.chosen-single');
        searchTrigger.on('click', function() {
            $('.chosen-container-active').toggleClass('chosen-with-drop');
        });
    };
    sidebarLogin();
  ...
  --------------------- */
    ...
    /*--- showpayment toggle function ----*/
    $('#payment-1').on('click', function() {
        $('#box-payment-1').slideToggle(1000);
    })

    $('#payment-2').on('click', function() {
        $('#box-payment-2').slideToggle(1000);
    })
